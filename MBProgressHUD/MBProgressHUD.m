...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:attrs];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:attrs context:nil].size;
